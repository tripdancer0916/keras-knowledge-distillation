...
x = Convolution2D(64, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
...
x = Convolution2D(128, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
x = advanced_activations.LeakyReLU(alpha=0.1)(x)
x = Convolution2D(128, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
...
x = Convolution2D(256, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
x = advanced_activations.LeakyReLU(alpha=0.1)(x)
x = Convolution2D(256, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
...
x = Convolution2D(512, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
x = advanced_activations.LeakyReLU(alpha=0.1)(x)
x = Convolution2D(512, (3, 3), padding='same', kernel_regularizer=regularizers.l2(weight_decay))(input_layer)
x = BatchNormalization()(x)
